...
export const PINATA_ERROR__SESSION_NOT_LIVE = 0x177a; // 6010
/** InvalidZeroProofInstructionOffset: zero proof instruction offset must be zero or reference a preceding instruction */
export const PINATA_ERROR__INVALID_ZERO_PROOF_INSTRUCTION_OFFSET = 0x177b; // 6011
/** InvalidTerminalZeroProof: terminal zero proof is invalid or does not bind the HP vault */
export const PINATA_ERROR__INVALID_TERMINAL_ZERO_PROOF = 0x177c; // 6012
/** AttackCountOverflow: successful attack count overflowed */
export const PINATA_ERROR__ATTACK_COUNT_OVERFLOW = 0x177d; // 6013

export type PinataError =
  | typeof PINATA_ERROR__ATTACK_COUNT_OVERFLOW
  ...
  | typeof PINATA_ERROR__INVALID_TERMINAL_ZERO_PROOF
  | typeof PINATA_ERROR__INVALID_ZERO_PROOF_INSTRUCTION_OFFSET
  ...
  | typeof PINATA_ERROR__SESSION_NOT_LIVE
  | typeof PINATA_ERROR__TOKEN2022_CPI;

let pinataErrorMessages: Record<PinataError, string> | undefined;
if (process.env["NODE_ENV"] !== "production") {
  pinataErrorMessages = {
    [PINATA_ERROR__ATTACK_COUNT_OVERFLOW]: `successful attack count overflowed`,
    ...
    [PINATA_ERROR__INVALID_TERMINAL_ZERO_PROOF]: `terminal zero proof is invalid or does not bind the HP vault`,
    [PINATA_ERROR__INVALID_ZERO_PROOF_INSTRUCTION_OFFSET]: `zero proof instruction offset must be zero or reference a preceding instruction`,
    ...
    [PINATA_ERROR__SESSION_NOT_LIVE]: `session is not live`,
